...
export default function AdminPermissions() {
  ...
  const fetchRolePermissions = async () => {
    try {
      const response = await authAPI.authenticatedFetch('/api/admin/role-permissions');
  ...
  const handleUpdatePermission = async () => {
    ...
    try {
      const response = await authAPI.authenticatedFetch(`/api/admin/permissions/${selectedPermission.id}`, {
        method: 'PUT',
        body: JSON.stringify(newPermission)
      });
  ...
  const handleDeletePermission = async (id: number) => {
    ...
    try {
      const response = await authAPI.authenticatedFetch(`/api/admin/permissions/${id}`, {
        method: 'DELETE'
      });
