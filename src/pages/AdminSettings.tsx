...
export default function AdminSettings() {
  ...
  const fetchSettings = useCallback(async () => {
    try {
      setLoading(true);
      const response = await authAPI.authenticatedFetch('/api/admin/settings');
  ...
  const handleTestEmail = async () => {
    ...
    try {
      ...
      const response = await authAPI.authenticatedFetch('/api/admin/settings/test-email', {
        method: 'POST',
  ...
  const handleCreateBackup = async () => {
    try {
      ...
      const response = await authAPI.authenticatedFetch('/api/admin/backup', {
        method: 'POST'
      });
  ...
  const handleClearCache = async () => {
    try {
      const response = await authAPI.authenticatedFetch('/api/admin/cache/clear', {
        method: 'DELETE'
      });
